...
bool Pilot::proper_heading(Waypoint &estimated_pos, int n) {
  ...
  Serial.println("Heading needed: " + String(properHeading) + ", Current Heading: " + String(estimated_pos.bearing_deg));
 ...
 *******************************************************************************************************/
 ...
 //   myPlanner->path0.east_mm =  6925;
 //   myPlanner->path0.north_mm = 5893;

 //   myPlanner->path1.east_mm = 11735;
 //   myPlanner->path1.north_mm = 5913;

 //   myPlanner->path2.east_mm = 17416;
 //   myPlanner->path2.north_mm = 18791;
//
 //   myPlanner->path[0] = pathz0;
 //   myPlanner->path[1] = pathz1;
 //   myPlanner->path[2] = pathz2;

 //   for (int i = 0; i < 3; i++) {
 //       myPlanner->path[i].vectors(&pathz[i+1]);
 //   }
//}
